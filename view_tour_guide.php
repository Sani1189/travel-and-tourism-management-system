...
<div class="container mt-5">
    <h1 class="ticket">View Tour Guide</h1>
    ...
    $sql = "SELECT * FROM tour_guide ORDER BY guide_id DESC LIMIT 1";
    ...
    if ($result->num_rows > 0) {
        ...
        <div class="ticket_div">
            ...
            <p><strong>Hourly Rent:</strong> <?php echo $row['hourly_rent']; ?></p>
            <p><strong>Spoken Skill:</strong> <?php echo $row['spoken_skill']; ?></p>
