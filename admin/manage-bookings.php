...
if (strlen($_SESSION['alogin']) == 0) {
	...
	<head>
		<title>TourEase | Admin manage Bookings</title>
					...
					<div class="agile-tables">
						<div class="w3l-table-info">
							...
							<table id="table">
								...
								<tbody>
									<?php $sql = "SELECT tblbooking.BookingId as bookid,tblusers.FullName as fname,tblusers.MobileNumber as mnumber,tblusers.EmailId as email,tbltourpackages.PackageName as pckname,tblbooking.PackageId as pid,tblbooking.FromDate as fdate,tblbooking.status as status,tblbooking.CancelledBy as cancelby,tblbooking.UpdationDate as upddate,tblbooking.addsOn as addsOn,tblbooking.total as total,tblbooking.child as child,tblbooking.adult as adult,tblbooking.senior as senior,tblbooking.RegDate as rdate, tblbooking.pkgtype as pkgtype from tblbooking join tblusers on tblbooking.UserEmail=tblusers.EmailId join tbltourpackages on tblbooking.PackageId=tbltourpackages.PackageId order by bookid desc";
									$query = $dbh->prepare($sql);
									$query->execute();
									...
									if ($query->rowCount() > 0) {
										foreach ($results as $result) { ?>
											<tr>
												...
												<td>
													<?php echo htmlentities($result->addsOn); ?>
												</td>
												<td>
