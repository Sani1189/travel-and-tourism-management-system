...
$sql="update TblTourPackages set PackageName=:pname,PackageType=:ptype,PackageLocation=:plocation,PackagePrice=:pprice,PackageFetures=:pfeatures,PackageDetails=:pdetails ,PackageInfo=:pinfo where PackageId=:pid";
                            ...
                            <form class="form-horizontal" name="package" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <label for="focusedinput" class="col-sm-2 control-label">Additional
                                        Information</label>
                                    <div class="col-sm-8">
                                        <textarea class="form-control" rows="5" cols="50" name="packageInfo"
                                            id="packageInfo" placeholder="Additional Information"
                                            required><?php echo htmlentities($result->PackageInfo);?></textarea>
                                    </div>
                                </div>
                                <div class="form-group">
